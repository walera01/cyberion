...
let token = `AAE2lpDgQEtBy2li7wCvcJTplxxAs11LAFQ` //получаем при создании бота

let chatId = `417440391` //получаем при вызове https://api.telegram.org/bot5312585208:AAE2lpDgQEtBy2li7wCvcJTplxxAs11LAFQ/getupdates в браузере

let botId = `5312585208`
...
<div class="chat__input">
    ...
    <button class="chat__input__submit" aria-label="Отправить сообщение""></button>
</div>
